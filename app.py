...
def result():
    try:
        ...
        # matchType 50의 division 가져오기
        match_type_50 = next((item for item in division_info if item["matchType"] == 50), None)
        if match_type_50:
            tier_id = match_type_50.get("division", "정보 없음")
        ...
        urlString = "https://open.api.nexon.com/fconline/v1/user/match?ouid=" + characterName + "&matchtype=50&limit=20"
